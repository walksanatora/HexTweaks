...
import hexdoc_hextweaks

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HextweaksPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HextweaksModPlugin(branch=branch)


class HextweaksModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hextweaks"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hextweaks, "_templates"
